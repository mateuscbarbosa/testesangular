...
describe(ActionDirective.name, () =>{
    ...
    it(`(D) (@Output appAction) should mit event with payload when ENTER key is pressed`, () => {
    ...
    it(`(D) (@Output appAction) should mit event with payload when clicked`, () => {
        const divEl: HTMLElement = fixture.nativeElement.querySelector('.dummy-component');
    ...
    it(`(D) (@Output appAction) should mit event with payload when clicked or ENTER key pressed`, () => {
        const divEl: HTMLElement = fixture.nativeElement.querySelector('.dummy-component');
        ...
        expect(component.hasEvent()).withContext('Keyboard event keydown').toBeTrue();
    });
});
